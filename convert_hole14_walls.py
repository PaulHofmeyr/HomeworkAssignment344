#!/usr/bin/env python3
"""Regenerate hole-14 turf walls in TurfWall.cpp from hole-14-turf-wall.csv."""
...
DEFAULT_CSV = ROOT / "hole-14-turf-wall.csv"
BEGIN = "// BEGIN HOLE14_TURF_WALL_DATA (auto-generated — do not edit by hand)"
END = "// END HOLE14_TURF_WALL_DATA"
...
def emit_cpp(segments: OrderedDict[str, list[tuple[int, int]]], source: str) -> str:
    ...
    lines += ["static void addHole14TurfWallSegments(TurfWall* wall)", "{"]
...
def main() -> None:
    ...
    if BEGIN not in text:
        text = text.replace("// BEGIN HOLE13_TURF_WALL_DATA", BEGIN + "\n" + END + "\n\n// BEGIN HOLE13_TURF_WALL_DATA", 1)
