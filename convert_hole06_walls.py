#!/usr/bin/env python3
"""Regenerate hole-6 turf walls in TurfWall.cpp from hole-6-turf-wall.csv."""
...
DEFAULT_CSV = ROOT / "hole-6-turf-wall.csv"
BEGIN = "// BEGIN HOLE06_TURF_WALL_DATA (auto-generated — do not edit by hand)"
END = "// END HOLE06_TURF_WALL_DATA"
...
def emit_cpp(segments: OrderedDict[str, list[tuple[int, int]]], source: str) -> str:
    ...
    lines += ["static void addHole06TurfWallSegments(TurfWall* wall)", "{"]
...
def main() -> None:
    ...
    if BEGIN not in text:
        text = text.replace("// BEGIN HOLE07_TURF_WALL_DATA", BEGIN + "\n" + END + "\n\n// BEGIN HOLE07_TURF_WALL_DATA", 1)
