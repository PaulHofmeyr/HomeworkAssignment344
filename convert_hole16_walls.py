#!/usr/bin/env python3
"""Regenerate hole-16 turf walls in TurfWall.cpp from hole-16-turf-wall.csv."""
...
DEFAULT_CSV = ROOT / "hole-16-turf-wall.csv"
BEGIN = "// BEGIN HOLE16_TURF_WALL_DATA (auto-generated — do not edit by hand)"
END = "// END HOLE16_TURF_WALL_DATA"
...
def emit_cpp(segments: OrderedDict[str, list[tuple[int, int]]], source: str) -> str:
    ...
    lines += ["static void addHole16TurfWallSegments(TurfWall* wall)", "{"]
...
def main() -> None:
    ...
    if BEGIN not in text:
        text = text.replace("// BEGIN HOLE15_TURF_WALL_DATA", BEGIN + "\n" + END + "\n\n// BEGIN HOLE15_TURF_WALL_DATA", 1)
