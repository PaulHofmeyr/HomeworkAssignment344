#!/usr/bin/env python3
"""Regenerate hole-13 turf walls in TurfWall.cpp from hole-13-turf-wall.csv."""
...
DEFAULT_CSV = ROOT / "hole-13-turf-wall.csv"
BEGIN = "// BEGIN HOLE13_TURF_WALL_DATA (auto-generated — do not edit by hand)"
END = "// END HOLE13_TURF_WALL_DATA"
...
def emit_cpp(segments: OrderedDict[str, list[tuple[int, int]]], source: str) -> str:
    ...
    lines += ["static void addHole13TurfWallSegments(TurfWall* wall)", "{"]
...
def main() -> None:
    ...
    if BEGIN not in text:
        text = text.replace("// BEGIN HOLE12_TURF_WALL_DATA", BEGIN + "\n" + END + "\n\n// BEGIN HOLE12_TURF_WALL_DATA", 1)
